...
<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li class="active">Reporte Notas(Secci&oacute;n, Materia, A&ntilde;o Lectivo)</li>
	                                </ul>
                            	</div>
                        	</div>
                                ...
                                <div class="block-content collapse in">
										...
										<h4 class="alert-heading">Informaci&oacute;n</h4>
										 <?php echo $Informacion;?>
										  ...
										  <form action="<?php echo base_url();?>Reportesnotas/GenerarReporteNotas" method ="POST" id="form_registro" class="form-horizontal" target="_blank">
											...
											<fieldset>
													...
													<div class="control-group">
														...
														<div class="controls">
															<select class="span6 m-wrap" name="annio" id="annio">
																
																<option value="">Seleccione...</option>
																<?php 
																 foreach($TraerAnniosDelDocenteGenerales as $anniosEncontadas):
																	
																?>
																<option value="<?php echo $anniosEncontadas->annio;?>"><?php echo $anniosEncontadas->annio;?></option>
																<?php
																endforeach;
																?>
															</select>
